...
print(clean_df,n=5)
```
 * Adding row numbers to clean data which we will be using it to ignore descriptions from excel.
...
ggplot(analytical_df, aes(x=as.yearmon(TARIH), group=1)) +
  ...
  theme_minimal() + 
  labs(x = 'Housing Sales Period', y = 'Number of houses sold', color = "Acquired By", title = "First Hand vs Second Hand")
```